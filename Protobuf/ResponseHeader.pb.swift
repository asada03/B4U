...
struct Proto_ResponseHeader {
  ...
  var responseType: Proto_ResponseType = .answerOnly
  ...
  var stateProof: Data = SwiftProtobuf.Internal.emptyData
...
extension Proto_ResponseHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    func _protobuf_generated_isEqualTo(other: Proto_ResponseHeader) -> Bool {
        return false
    }
  ...
  static func ==(lhs: Proto_ResponseHeader, rhs: Proto_ResponseHeader) -> Bool {
