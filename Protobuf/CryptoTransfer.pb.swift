...
struct Proto_AccountAmount {
  ...
  /// an account that sends or receives cryptocurrency
  ...
  /// number of tinybars that the account sends (negative) or receives (positive)
  var amount: Int64 {
...
struct Proto_TransferList {
  ...
  /// list of AccountAmount pairs, each of which has an account and an amount to transfer into it (positive) or out of it (negative)
