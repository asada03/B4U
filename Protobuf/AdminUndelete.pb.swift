...
struct Proto_AdminUndeleteTransactionBody {
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Proto_AdminUndeleteTransactionBody.OneOf_ID, rhs: Proto_AdminUndeleteTransactionBody.OneOf_ID) -> Bool {
      switch (lhs, rhs) {
...
extension Proto_AdminUndeleteTransactionBody: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    
  static let protoMessageName: String = _protobuf_package + ".AdminUndeleteTransactionBody"
  ...
  fileprivate class _StorageClass {
    var _id: Proto_AdminUndeleteTransactionBody.OneOf_ID?
  ...
  static func ==(lhs: Proto_AdminUndeleteTransactionBody, rhs: Proto_AdminUndeleteTransactionBody) -> Bool {
